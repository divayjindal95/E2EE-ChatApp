...
public class InMemorySignalProtocolStore implements SignalProtocolStore {
  ...
  public InMemorySignalProtocolStore(IdentityKeyPair identityKeyPair, int registrationId,SignedPreKeyRecord signedPreKey,int signedPreKeyId,List<PreKeyRecord> preKeys) {
    ...
    this.signedPreKeyStore.storeSignedPreKey(signedPreKeyId, signedPreKey);
    this.preKeyStore = new InMemoryPreKeyStore();
    for(int i=0;i<preKeys.size();i++)
    	this.preKeyStore.storePreKey(0, preKeys.get(i));
